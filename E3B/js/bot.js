/*
		Bot creado por Alberto Miranda Garcia

		https://github.com/AlbertoMGV/TwitterMultiToolBot
...
function getTuitsBot(name){
	console.log("Estoy en bot.js");
	var params = {
		screen_name : name,
	}
	var tuits;
